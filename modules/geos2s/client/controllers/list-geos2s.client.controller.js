(function () {
  ...
  angular
    .module('geos2s')
    .controller('Geos2sListController', Geos2sListController);

  Geos2sListController.$inject = ['Geos2sService'];

  function Geos2sListController(Geos2sService) {
    var vm = this;
...
// dvdf.timer.utils.lap("Finshed loading dc_chart_paramters ...");
    ...
    d3_queue.queue()
        .defer(d3.json, './custom-world-countries.json')
        .defer(d3.tsv, './OUTPUT_simply_mortalite_short_detailed_evolution.tsv')
...
// function dc_make_all_charts_ready(dc_chart_ids, dc_charts, dc_chart_types) {
    ...
    function load_detailed_data() {
      ...
      d3.tsv('./OUTPUT_simply_mortalite_detailed_evolution.tsv', function(error, mortalite_detailed_data) {
