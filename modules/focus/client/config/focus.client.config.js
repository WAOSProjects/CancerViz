(function () {
  ...
  function menuConfig(sideNavs, navs, appStore) {
    ...
    var _app = {
      ...
      state: 'focus.view', //main route
      icon: 'fa fa-signal', //https://fortawesome.github.io/Font-Awesome/
      ...
      preview: 'modules/core/client/img/focus.png',
      excerpt: 'Quelques visualisation faisant un Focus sur quelques données sortant du lot.',
      screenshots: {
